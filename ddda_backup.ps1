...
# REPLACE: For me save file resides here C:\Program Files (x86)\Steam\userdata\342408821\367500\Remote\DDDA.sav
# so my steam user id is 342408821
$uid = 342408821

# REPLACE: note this is where I have the game executable, change it for your installation
$exe = "G:\games\steam\steamapps\common\DDDA\dda.exe"
...
$watcher.Path = "C:\Program Files (x86)\Steam\userdata\$uid\367500\remote"
...
$action =
    {
		...
		$dd_save_file = "C:\Program Files (x86)\Steam\userdata\$uid\367500\Remote\DDDA.sav"

		# when was it last saved
		$dd_save_file_date = (gci $dd_save_file).LastWriteTime

		# put the backup folder next to "Remote" folder
		$dd_backup_folder="C:\Program Files (x86)\Steam\userdata\$uid\367500\Backup"

		# find the latest backed up save file & its date
		$last_backup = (gci "C:\Program Files (x86)\Steam\userdata\$uid\367500\Backup" |Sort-Object LastWriteTime)[-1]
